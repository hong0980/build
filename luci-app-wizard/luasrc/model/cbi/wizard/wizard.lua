...
-- wan_proto:value('ap', translate('交换机 (AP)'))
...
wan_dns = s:option(DynamicList, 'wan_dns', translate('WAN DNS 服务器'))
...
if iswireless then
    ...
    ap_password = s:option(Value, 'ap_password', translate('Wi-Fi Password'),
        translate('Wi-Fi 密码，至少 8 字符，留空则无密码'))
