...
return view.extend({
	...
	render: function ([info, m_running, u_running]) {
		...
		o = batadvopt(s, form.RichListValue, 'routing_algo', '', _('Routing Algorithm'),
		...
		o = batadvopt(s, form.Value, 'elp_interval', { 'routing_algo': 'BATMAN_V' }, _('ELP Interval'),
			_('Interval in ms for neighbor probing'));
		o.datatype = 'min(1)';
		o.default = '500';
		...
		o.placeholder = 0; o.datatype = 'integer';
		...
		o.placeholder = 5000; o.datatype = 'uinteger';
		...
		o.placeholder = 60000; o.datatype = 'uinteger';
		...
		o.placeholder = 3; o.datatype = 'uinteger';
		...
		o.placeholder = 0; o.datatype = 'uinteger';
		...
		o.placeholder = 10000; o.datatype = 'uinteger';
		...
		o.placeholder = 75; o.datatype = 'uinteger';
		...
		o.placeholder = 120000; o.datatype = 'uinteger';
		...
		o.placeholder = -60; o.datatype = 'integer';
		...
		o.placeholder = 30000; o.datatype = 'uinteger';
		...
		m.parse = function () {
			...
			function migrate(oldName, newName, defaults) {
				if (!newName) return;
				...
				if (!uci.get('network', newName)) {
					...
					if (renamed && oldSection) {
						for (var key in oldSection) {
							if (key.charAt(0) === '.') continue;
							uci.set('network', newName, key, oldSection[key]);
						}
					} else {
						for (var k in defaults) uci.set('network', newName, k, defaults[k]);
					}
				}
				if (renamed && oldSection) uci.remove('network', oldName);
			}
